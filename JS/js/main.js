...
window.onload = function () {
    ...
    const SCENE = [
        ...
        sur.sphera(20, 10, new Point(0, 0, 0)), //солнце 0
    ...
    function mousemove(event) {//крутим фигуры мышкой
        ...
        if (canRotate) {
            if (event.movementX) {
                const alpha = canvas.sx(event.movementX) / WINDOW.CAMERA.z * 45;
            ...
            if (event.movementY) {
                const alpha = canvas.sy(event.movementY) / -WINDOW.CAMERA.z * 45;
